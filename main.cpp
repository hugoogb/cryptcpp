#include "src/methods/alphabet.h"
#include "src/methods/cipher.h"
#include "src/methods/encoding.h"
#include "src/methods/transform.h"
#include "src/util/menu.h"
#include "src/util/struct.h"
